...
class AdminOrder {
    private $conn;
    private $table_name = "admin_orders";
    ...
    public function create() {
        ...
        $this->unit_type = isset($this->unit_type) ? htmlspecialchars(strip_tags($this->unit_type)) : 'per piece';
        $this->variation = isset($this->variation) ? htmlspecialchars(strip_tags($this->variation)) : null;
