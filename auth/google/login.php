 ...
 * Initiates Google OAuth flow and redirects user to Google
 */
session_start();
...
// Get the role the user wants to log in as (admin, staff, or supplier)
...
if (empty($redirectUri)) {
    header('Location: ' . $appBase . '/login.php?error=' . urlencode('Redirect URI is empty. Please check your configuration.'));
    exit;
}
