...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $confirm_password = $_POST['confirm_password'] ?? '';
    $email = $_POST['email'] ?? '';
    $role = 'staff'; // Fixed for staff registration
    $phone = $_POST['phone'] ?? '';
    $address = trim($_POST['address'] ?? '');
    $city = trim($_POST['city'] ?? '');
    $province = trim($_POST['province'] ?? '');
...
<head>
    ...
    <title>Staff Registration - Inventory & Stock Control System</title>
                ...
                <div class="card shadow">
                    <div class="card-body p-5">
                        <h2 class="text-center mb-4">
                            <i class="bi bi-person-badge text-success me-2"></i>Staff Registration
                        </h2>
                        ...
                        <form method="POST" action="" id="registrationForm">
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-success btn-lg">Create Staff Account</button>
                            </div>
                        </form>
    ...
    <script>
        function verifyWithGoogle() {
            ...
            fetch('?save_form_data=1', {
                ...
                window.location.href = '<?php echo $rootBase; ?>/auth/google/register.php?role=staff';
