-- Create separate supplier catalog tables to decouple from admin inventory
USE inventory_db;

-- Supplier catalog table (independent from admin inventory)
...
-- Supplier product variations table
